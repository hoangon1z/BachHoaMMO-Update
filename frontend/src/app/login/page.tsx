...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Check if user has 2FA enabled, if not suggest to enable
      if (result.user && !result.user.twoFactorEnabled) {
        setTimeout(() => {
          toast.info('Bảo mật tài khoản', 'Hãy bật xác thực 2 bước (2FA) để bảo vệ tài khoản tốt hơn. Vào Cài đặt → Bảo mật để kích hoạt.');
        }, 1500);
      }
  ...
  const features = [
    { icon: Shield, title: 'Giao dịch an toàn', desc: 'Bảo mật người mua và người bán' },
    { icon: Zap, title: 'Bảo mật thông tin', desc: 'Mã hóa SSL 256-bit cho mọi giao dịch' },
      ...
      <div className="hidden lg:flex lg:w-1/2 xl:w-[45%] bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 xl:p-16 w-full">
          ...
          <Link href="/" className="flex items-center gap-3">
            <div className="w-11 h-11 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center overflow-hidden">
              <img src="/images/logobachhoa.png" alt="BachHoaMMO" className="w-8 h-8 object-contain" />
            </div>
      ...
      <div className="w-full lg:w-1/2 xl:w-[55%] flex items-center justify-center p-6 sm:p-8 lg:p-12">
        <div className="w-full max-w-md">
          ...
          <Link href="/" className="lg:hidden flex items-center gap-2.5 mb-8">
            ...
            <span className="text-xl font-bold text-gray-900">Bach<span className="text-blue-600">HoaMMO</span></span>
          </Link>
